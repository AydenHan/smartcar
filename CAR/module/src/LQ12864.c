...
#define LCD_DC	PTE25_OUT  //E25
#define LCD_RST	PTE28_OUT  //E28
#define LCD_SDA	PTA16_OUT  //A16
#define LCD_SCL	PTC5_OUT  //C5
//背光E24
...
{
    /*-----端口初始化---- */
      gpio_init(PTC5, GPO, 0);   //D0,clk	
	  gpio_init(PTA16, GPO, 0);   //D1
	  gpio_init(PTE28, GPO, 0);   //RES
	  gpio_init(PTE25, GPO, 0);   //DC
